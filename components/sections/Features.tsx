...
export default function Features() {
  return (
    <section id="features" className="bg border-y-4 border-dashed py-16">
      <div className="bg-banner relative mb-8 flex h-72 flex-col items-center justify-center gap-8 rounded-[25px] bg-cover bg-no-repeat p-6 shadow-inner max-md:hidden ">
